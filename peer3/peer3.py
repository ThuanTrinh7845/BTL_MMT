...
class PeerClient:
    ...
    def save_hosted_channels(self, filename='peer3_hosted_channels.json'):
        """Lưu hosted_channels vào file JSON"""
        with open(filename, 'w') as f:
            json.dump(self.hosted_channels, f)

    def save_joined_channels(self, filename='peer3_joined_channels.json'):
        """Lưu joined_channels vào file JSON"""
        with open(filename, 'w') as f:
            json.dump(self.joined_channels, f)

    def load_hosted_channels(self, filename='peer3_hosted_channels.json'):
    ...
    def load_joined_channels(self, filename='peer3_joined_channels.json'):
...
#     peer_ip = socket.gethostbyname(socket.gethostname())  # Lấy IP của máy
#     peer_port = 33359
...
#     peer = PeerClient(tracker_ip, tracker_port, peer_ip, peer_port, username, password, session_id)
#     peer.start()