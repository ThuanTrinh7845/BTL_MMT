...
class Peer2LoginApp:
    def __init__(self, root):
        ...
        self.server_ip = "192.168.128.241"  # Địa chỉ IP của tracker
    ...
    def attempt_login(self):
        ...
        self.peer_client = PeerClient(self.server_ip, self.server_port, self.get_host_ip(), 33358, username, password, "sid2")
    ...
    def open_main_app(self, username):
        ...
        main_window = tk.Tk()
        app = Peer2MainApp(main_window, username, self.peer_client)
